        ...
        return (
          <button
            ...
            className={`text-xl leading-none transition ${
              filled ? 'text-[var(--color-accent)]' : 'text-[#E7DCD2]'
            }`}
  ...
  return (
    <div className="mx-auto max-w-[1180px] pb-12">
      <button
        ...
        className="mb-4 inline-flex h-9 items-center rounded-full border border-[var(--border-color)] bg-white px-4 text-sm font-extrabold text-[var(--text-secondary)] shadow-[var(--shadow-sm)] transition hover:bg-[var(--bg-surface)]"
      >
        ← 목록으로
      </button>
